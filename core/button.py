...
class CloseButton(discord.ui.Button):
	def __init__(self):
		super().__init__(style = discord.ButtonStyle.red, label = "Close", custom_id = "close")
...
class AddUserButton(discord.ui.Button):
	def __init__(self):
		super().__init__(style = discord.ButtonStyle.green, label = "Add User", custom_id = "adduser")
	...
	async def callback(self, interaction:discord.Interaction):
		...
		if user:
			...
			await interaction.response.send_message("The user was not found.", ephemeral = True)

class ClaimButton(discord.ui.Button):
	def __init__(self):
		super().__init__(style = discord.ButtonStyle.green, label = "Claim", custom_id = "claim")
